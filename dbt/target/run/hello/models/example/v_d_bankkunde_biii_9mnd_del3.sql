  ...
  create or replace   view RISIKO.LGD.v_d_bankkunde_biii_9mnd_del3
...
SELECT level, 
  ...
  k.*
  FROM RISIKO.LGD.v_d_bankkunde_biii_9mnd k
    START WITH sk_bankkunde_biii_id in (select sk_bankkunde_biii_id from RISIKO.LGD.v_d_bankkunde_biii_9mnd_del2 )
